# <a name="how-to-run-the-completed-project"></a><span data-ttu-id="c6243-101">Exécution du projet terminé</span><span class="sxs-lookup"><span data-stu-id="c6243-101">How to run the completed project</span></span>
